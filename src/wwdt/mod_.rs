...
impl WDPROTECTR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            WDPROTECTR::PROTECTED => false,
            WDPROTECTR::UNPROTECTED => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> WDPROTECTR {
        match value {
            false => WDPROTECTR::PROTECTED,
            true => WDPROTECTR::UNPROTECTED,
        }
    }
...
impl WDPROTECTW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            WDPROTECTW::PROTECTED => false,
            WDPROTECTW::UNPROTECTED => true,
        }
    }
}
#[doc = r" Proxy"]
