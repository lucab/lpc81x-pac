...
impl SETCLR0R {
    ...
    #[doc = "Checks if the value of the field is `REVERSED_ON_H`"]
    #[inline]
    pub fn is_reversed_on_h(&self) -> bool {
        *self == SETCLR0R::REVERSED_ON_H
    }
}
...
impl<'a> _SETCLR0W<'a> {
    ...
    #[doc = "Set and clear are reversed when counter H is counting down. Do not use if UNIFY = 1."]
    #[inline]
    pub fn reversed_on_h(self) -> &'a mut W {
        self.variant(SETCLR0W::REVERSED_ON_H)
    }
...
impl<'a> _SETCLR1W<'a> {
    ...
    #[inline]
    pub fn reversed_on_h(self) -> &'a mut W {
        self.variant(SETCLR1W::REVERSED_ON_H)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl<'a> _SETCLR2W<'a> {
    ...
    #[inline]
    pub fn reversed_on_h(self) -> &'a mut W {
        self.variant(SETCLR2W::REVERSED_ON_H)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl<'a> _SETCLR3W<'a> {
    ...
    #[inline]
    pub fn reversed_on_h(self) -> &'a mut W {
        self.variant(SETCLR3W::REVERSED_ON_H)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
