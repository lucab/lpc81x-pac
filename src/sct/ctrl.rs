...
impl BIDIR_LR {
    ...
    pub fn _from(value: bool) -> BIDIR_LR {
        match value {
            false => BIDIR_LR::CLEAR_TO_ZERO,
            true => BIDIR_LR::THE_COUNTER_COUNTS_U,
        }
    }
    #[doc = "Checks if the value of the field is `CLEAR_TO_ZERO`"]
    #[inline]
    pub fn is_clear_to_zero(&self) -> bool {
        *self == BIDIR_LR::CLEAR_TO_ZERO
    }
...
impl<'a> _BIDIR_LW<'a> {
    ...
    #[doc = "The counter counts up to its limit condition, then is cleared to zero."]
    #[inline]
    pub fn clear_to_zero(self) -> &'a mut W {
        self.variant(BIDIR_LW::CLEAR_TO_ZERO)
    }
    #[doc = "The counter counts up to its limit, then counts down to a limit condition or to 0."]
    #[inline]
...
impl<'a> _BIDIR_HW<'a> {
    ...
    #[inline]
    pub fn clear_to_zero(self) -> &'a mut W {
        self.variant(BIDIR_HW::CLEAR_TO_ZERO)
    }
    #[doc = "The H counter counts up to its limit, then counts down to a limit condition or to 0."]
    #[inline]
